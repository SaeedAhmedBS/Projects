...
public class Bskeybad {

    private List<PropertyChangeListener> listener = new ArrayList<PropertyChangeListener>();
    public static final String KEY = "key";
    private char keyPressed;

    static GpioController theGpio ;
    /**
     * The Constant KEYPAD.
     */
     ...
     */
    private static final Pin PIN_1_IN = RaspiPin.GPIO_00;

    /**
     * The Constant PIN_2_IN.
     */
    private static final Pin PIN_2_IN = RaspiPin.GPIO_01;
     ...
     */
    private static final Pin PIN_5_OUT = RaspiPin.GPIO_04;

    /**
     * The Constant PIN_6_OUT.
     */
    private static final Pin PIN_6_OUT = RaspiPin.GPIO_05;

    /**
     * The Constant PIN_7_OUT.
     */
    private static final Pin PIN_7_OUT = RaspiPin.GPIO_06;

    /**
     * The Constant PIN_8_OUT.
     */
    private static final Pin PIN_8_OUT = RaspiPin.GPIO_07;
    ...
    public static void main(String[] args) {
        theGpio = GpioFactory.getInstance();
        Bskeybad bsk = new Bskeybad();
